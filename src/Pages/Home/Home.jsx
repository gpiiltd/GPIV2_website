        ...
        <div className="flex flex-col gap-4 md:flex-row md:gap-24">
          <section className="pt-4 lg:pt-24 md:pl-8">
            <div>
              ...
              <button className="hidden border-2 border-green mt-4 py-3 px-8  rounded-full cursor-pointer bg-green hover:bg-transparent hover:text-green  text-white duration-300 md:block md:mt-8">
              <Link
              to="contact"
              smooth={true}
              duration={700}
